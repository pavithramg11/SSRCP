...
const ExportAlertsPopup = ({ open, onClose }) => {
  ...
  const handleExport = async () => {
    try {
      ...
      if (format === "json") {
        const jsonBlob = new Blob([JSON.stringify(alertData, null, 2)], {
        ...
        const csvData = convertToCSV(alertData);
...
export default ExportAlertsPopup;
